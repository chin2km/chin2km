import { hrefHtml, inlineEmoji } from './styles/styleSettings';
...
export const INTRO: string[] = [
  ...
  `I am a fullstack software developer with over ${getExperience(
    10,
    1,
    2012
  )} years of professional experience working with some awesome developers...`,
...
export const WORKS: IWork[] = [
  ...
  },
  {
    ...
    imageShadow: false,
    chat: [
      `This is me playing with Svelte during a corona lockdown weekend and falling in love with it ${inlineEmoji(
        `❤️`
      )}`,
